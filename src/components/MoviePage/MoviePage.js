...
export default class MoviePage extends Component {
    ...
    getCast = () =>{
        let movieID = this.props.match.params.id;
        axios.get(`https://api.themoviedb.org/3/movie/${movieID}/credits?api_key=12aa3499b6032630961640574aa332a9`)
        .then( result =>{
            this.setState({
    ...
    getReviews = () =>{
        let movieID = this.props.match.params.id;
        axios.get(`https://api.themoviedb.org/3/movie/${movieID}/reviews?api_key=12aa3499b6032630961640574aa332a9`)
        .then( results =>{
            this.setState({
    ...
    getSimilar = () =>{
        let movieID = this.props.match.params.id;
        axios.get(`https://api.themoviedb.org/3/movie/${movieID}/similar?api_key=12aa3499b6032630961640574aa332a9`)
        .then( results =>{
            this.setState({
    ...
    getImages = () =>{
        let movieID = this.props.match.params.id;
        axios.get(`https://api.themoviedb.org/3/movie/${movieID}/videos?api_key=12aa3499b6032630961640574aa332a9`)
        .then( videos =>{
            this.setState({
    ...
    render() {
        let {movie, genres, homepage, director, actors, reviews, similar,videos} = this.state;
        let movieID = this.props.match.params.id;
        let directors  = director.map((element, index)=>{
        return <span>{index > 0 && ', '}{element.name}</span>;
        })
